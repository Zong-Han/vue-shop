<template>
  <section class="new-products pt-5 pb-5" id="new-products" v-cloak>
    <loading
      ...
      <div class="row justify-content-center align-items-center">
        <div class="col-12 col-lg-7">
          <div class="row justify-content-center ">
            ...
            >
              <router-link
                v-if="index<4"
                :to="{name:'productInfo',params: { id: newItem.id }}"
              >
                <img
                  class="new-products-img rounded d-block"
        ...
        <div class="col-12 col-lg-5 mt-3 text-center">
          <div class="new-product-info text-dark-blue">
            <p>我們秉持著獨一無二的精神</p>
            <p>為妳挑選出最適合妳的夏季裝扮</p>
            <p class="text-light-red">自信 優雅 甜美</p>
            <p>是我們為每一位女孩量身打造的</p>
            <p>讓我們與妳一起打造，這個 夏天</p>
          </div>
